...
Vagrant.configure("2") do |config|
  ...
  (1..$num_instances).each do |i|
    config.vm.define vm_name = "%s-%02d" % [$instance_name_prefix, i] do |config|
      ...
      ip = "172.17.8.#{i+100}"
      config.vm.network :private_network, ip: ip #, bridge: "eth0"
      ...
      config.vm.provision "file", source: "~/.ssh/id_rsa.pub", destination: "/home/core/.ssh/me.pub"
      config.vm.provision "shell", inline: "cat /home/core/.ssh/me.pub >> /home/core/.ssh/authorized_keys"
      #config.vm.provision "shell", inline: "sed -i '/10.0.2.3/d' /etc/resolv.conf"
